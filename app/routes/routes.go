...
func (p tApplication) AddUser() string {
	args := make(map[string]string)
...
func (p tUsers) MyRooms() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("Users.MyRooms", args).Url
}

func (p tUsers) EditSettings() string {
	args := make(map[string]string)
...
func (p tUsers) Profile() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("Users.Profile", args).Url
}

func (p tUsers) Avatar() string {
	args := make(map[string]string)
